...
/** An instance maintains information about a sprite for the GUI. <br>
 * A sprite is defined by a spritesheet, the information to interpret it <br>
 * (size of each image, etc), and information necessary to animate the sprite. */
public class Sprite {
	...
	private int cycle= 0;				// Which cycle of the animation are we at now?
						 				// (in [0, cycleSize - 1])

	/** Constructor: an instance with image at imageLoc, of size (width, height),<br>
	...
	/** Return offset (dRow, dCol) into the spritesheet. <br>
	 * Assume that (dRow, dCol) is the base offset, and subsequent animations are at <br>
	 * (dRow, dCol + 1), (dRow, dCol + 2) ... (dRow, dCol + cycleSize - 1)
	 *
