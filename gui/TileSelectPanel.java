...
public class TileSelectPanel extends JPanel {
	...
	/** Return the minimum x-coordinate to draw s in order to center it.<br>
	 * minX is the minimum x to center over,<br>
	 * width is the width of the area to center over */
